...
export async function createViewer(stage){
 ...
 try{gltf=await loader.loadAsync('./hero-smooth-bubble-decel-m.web.glb');}catch{gltf=await loader.loadAsync('./hero-smooth-bubble-decel-m.web.glb');}finally{draco.dispose();}
